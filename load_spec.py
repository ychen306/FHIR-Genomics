...
def process_profile(profile):
	...
	for element in elements:
		...
		if search_param is not None:
			...
			# these will be used by a chained query where type of referenced resource might be implied
	...
	search_params = {param['name']: param['type'] for param in search_params.values()}
...
def init(spec_dir):
	...
	for f in os.listdir(spec_dir):
		...
		if matched is not None:
			...
			elements, resource_search_params, resource_reference_types = load_and_process_profile(profile_loc)
